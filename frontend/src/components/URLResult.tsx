    ...
    return (
        <div className="space-y-4 p-2 w-full bg-white dark:bg-gray-800 transition-all duration-300">
            ...
            <div className="text-center">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Your shortened link is ready!</p>
            </div>
            ...
            {copied && <p className="text-center text-sm text-green-500 mt-1">Copied to clipboard!</p>}

            {/* Details */}
            <div className="pt-4 border-t border-gray-200 dark:border-gray-700 space-y-3 text-sm">
                <div className="flex justify-start gap-2">
                    <span className="font-medium text-gray-700 dark:text-gray-300">Original URL:</span>
                    <span className="text-gray-600 dark:text-gray-400 break-all text-right truncate text-nowrap">{result.originalUrl}</span>
                </div>
                {result.customAlias && (
                    <div className="flex justify-start gap-2">
                        <span className="font-medium text-gray-700 dark:text-gray-300">Custom alias:</span>
                        <span className="text-blue-600 dark:text-blue-400 font-mono">{result.customAlias}</span>
                    </div>
                )}
                {result.expiryDate && (
                    <div className="flex justify-start gap-2">
